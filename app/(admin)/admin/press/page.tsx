...
import { press as initialPress, type PressArticle } from '@/lib/data';

type Form = Omit<PressArticle, 'id'>;
...
export default function AdminPressPage() {
  const [items, setItems] = useState<PressArticle[]>([...initialPress]);
