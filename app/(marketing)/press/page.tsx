    ...
    <div className="min-h-screen bg-[#050505] pt-32 pb-20">
      <div className="container mx-auto px-6">
        ...
        <div className="mb-20">
          ...
          <h1 className="text-5xl md:text-8xl font-display font-medium text-white tracking-tighter uppercase">
            Press &amp; <br />
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border border-white/5 overflow-hidden bg-[#0A0A0B]">
                      {featured.cover_url && (
                        <div className="overflow-hidden bg-neutral-900 h-72 lg:h-[28rem]">
                      ...
                      <div className={`${featured.cover_url ? '' : 'lg:col-span-2'} flex flex-col justify-center p-8 lg:p-12`}>
                        <span className="inline-block text-[10px] font-mono font-bold uppercase tracking-widest text-[#D4A843] mb-4">
                          Featured
                        </span>
                        ...
                        <h2 className="text-3xl md:text-5xl font-display uppercase mb-6 text-white group-hover:underline decoration-1 underline-offset-4 leading-[0.95] tracking-tight">
                          {featured.title}
                        </h2>
                        {featured.excerpt && (
                  ...
                  {rest.length > 0 && (
                    <div className="grid grid-cols-1 gap-12">
                      {rest.map(article => (
                        ...
                        >
                          {article.cover_url && (
                            <div className="md:col-span-4 overflow-hidden bg-neutral-900 h-64 md:h-full">
                              {/* eslint-disable-next-line @next/next/no-img-element */}
                              <img
                          ...
                          >
                            <div>
                              ...
                              <h2 className="text-3xl md:text-4xl font-display uppercase mb-4 text-white group-hover:underline decoration-1 underline-offset-4">
                                {article.title}
                              </h2>
                              {article.excerpt && (
                            ...
                            <div className="flex items-center gap-2 text-xs font-mono font-bold uppercase tracking-widest mt-8 text-white">
                              Read Article <ArrowUpRight className="w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                            </div>
                          </div>
                        </Link>
